...
| **Test Case ID:** | TC-06 |
| **Date:** | |
| **Objective:** | To verify that the payroll engine applies the Philippine Labor Code premium rates used by this system — regular day 1.00x, overtime 1.25x on an ordinary day, night differential 1.10x of the applicable rate, rest day 1.30x, special non-working day 1.30x, and regular holiday 2.00x — that premiums compound in the order day type, then overtime, then night differential, and that the computed gross pay matches a manual calculation. |
| **Hardware Components Involved:** | API server, MySQL database server, workstation for the web portal |
| **Software Components Involved:** | PayrollEngine, RateCalculator, TimeWorked, StatutoryDeductions, Payroll Run web screen, holiday calendar, `tbl_attendance`, `tbl_overtime_request`, `tbl_payroll`, `tbl_payroll_detail` |
| **Test Setup:** | One employee with a `daily_rate` of ₱600.00, equivalent to ₱75.00 per hour over an eight-hour day, on a deployed crew. Pay period 2026-09-A (21 August – 5 September 2026). Holiday calendar: 21 August 2026, Ninoy Aquino Day (special non-working day), and 31 August 2026, National Heroes Day (regular holiday). Sunday is the rest day. Verified and synced roll call marks the employee Present on Friday 21 August, Monday 24 August, Tuesday 25 August, Wednesday 26 August, Sunday 30 August and Monday 31 August, and Absent on every other working day of the period. Approved overtime requests: Tuesday 25 August, 4:00 PM – 6:00 PM, and Wednesday 26 August, 8:00 PM – midnight. |
| **Testing Procedure:** | 1. Confirm that the period's attendance rows carry `verified = true` and are synced, and that both overtime requests are approved. 2. Open the Payroll Run screen, select cut-off 2026-09-A, and compute payroll. 3. Open the employee's payslip and inspect `tbl_payroll_detail`; confirm the hour buckets: `regular_hours` = 24, `overtime_hours` = 6, `night_diff_hours` = 2, `rest_day_hours` = 8, `holiday_hours` = 16. 4. Compare the computed gross pay against the manual calculation. 5. Verify that SSS, PhilHealth, Pag-IBIG and withholding tax are each shown separately and that net pay equals gross pay less their sum. 6. Confirm that the row remains Draft, then approve it. |
| **Expected Result:** | The hour buckets match those listed above, and each day computes as: Fri 21 Aug, special day, 8 × ₱75.00 × 1.30 = ₱780.00; Mon 24 Aug, ordinary day, 8 × ₱75.00 = ₱600.00; Tue 25 Aug, ₱600.00 plus overtime 2 × ₱75.00 × 1.25 = ₱187.50; Wed 26 Aug, ₱600.00 plus overtime 8:00 – 10:00 PM, 2 × ₱75.00 × 1.25 = ₱187.50, plus night overtime 10:00 PM – midnight, 2 × ₱75.00 × 1.25 × 1.10 = ₱206.25; Sun 30 Aug, rest day, 8 × ₱75.00 × 1.30 = ₱780.00; Mon 31 Aug, regular holiday, 8 × ₱75.00 × 2.00 = ₱1,200.00. Computed gross pay is ₱5,141.25, matching the manual calculation to the centavo. `tbl_payroll.status` remains Draft until explicitly approved, each statutory deduction is itemised with a note stating why withholding tax is or is not due, and net pay equals gross pay less the itemised deductions. |
| **Actual Result:** | |
| **Pass/Fail:** | |
| **Comments/Observation:** | |
...
> **Revision (18 September 2026, agreed with the team):** the original TC-06 setup — two overtime hours on a day with no regular hours, and two night hours that were not overtime, for a gross of ₱2,932.50 — cannot arise from this system's data. Roll call records each worker's arrival on a fixed 7:00 AM shift, and overtime, including night work, is paid only from approved overtime requests. The revised setup uses days the system actually produces, keeps every multiplier under test, and adds the special non-working day and the compounding of overtime and night differential.
